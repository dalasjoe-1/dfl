...
epoch_num = 45000 #20000  # 에폭 횟수(학습용전체데이터를 몇 회 반복해서 학습할 것인가 입력)
...
#win_numbers = data[:,-1:data.size] # dalas
...
print("len(z)=", len(z), "len(data)=", len(data), "len(y)=", len(y))
...
print(dataX[0][0])
print("len=", len(dataX[0]), "dataX[0]=",dataX[0])
